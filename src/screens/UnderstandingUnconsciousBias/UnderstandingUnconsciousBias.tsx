...
const moduleItems = [
  {
    ...
    link: "/Module2Intro", // route for first card
  },
  {
    id: 2,
    title: "The Neuroscience of Bias",
    link: "/Neuroscience", // route for second card
  },
  {
    id: 3,
    title: "Recognising Bias in Clinical Settings",
    link: "/BiasIsHarmful"
  },
  {
    id: 4,
    title: "Impact on Clinical Decisions ",
    link: "/SubtleWays"
  },
  {
    id: 5,
    title: "Recognising Bias In Yourself",
        link: "/SubtleSigns"
...
export const UnderstandingUnconsciousBias = (): JSX.Element => {
  return (
    <div
    ...
    >
      ...
      <header className="relative w-full h-[171px] bg-[#2e3b42] rounded-[0px_0px_25px_25px] shadow-[0px_4px_4px_#00000040]">
        <h1 className="absolute w-[314px] top-[80px] left-1/2 -translate-x-1/2 font-['Poppins',Helvetica] font-bold text-white text-2xl text-center tracking-[0] leading-[32.4px]">
      ...
      {/* Module content */}
      <main className="pt-[28px] max-w-[390px] px-3 pb-6 flex flex-col gap-[19px]">
          ...
          const card = (
            ...
            >
              <CardContent className="p-0 h-full">
                ...
                {/* Module title */}
                <h2 className="absolute w-[238px]  max-w-[170px]  top-[19px] left-12 font-['Poppins',Helvetica] font-bold text-white text-[24px] text-base tracking-[0] leading-[21.6px] ">
                  {item.title}
                </h2>
