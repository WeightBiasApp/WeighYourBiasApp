...
export default function MiniSelfCheck () {
   const reflectionTitle = "Self Check Reflection";
...
const handleSave = () => {
  ...
  return (
    <main className="relative flex flex-col h-[1064px] w-full max-w-[400px] mx-auto bg-[#e6ebf0]">
      {/* Header */}
      ...
      {/* Instructions */}
        ...
        <h2 className="absolute max-w-[80%] left-[20px] right-[19px] top-[208px] text-[#2e3b42] font-semibold text-[18px] text-left leading-[20px] font-['Poppins']">
       Quick reflection after a consult or at the end of the day.  </h2>
      <section className="absolute top-[220px] px-5  text-center">
       
      <ul className="mt-14 text-[#2e3b42] text-[16px] font-['Poppins'] font-medium leading-[22px] list-disc pl-5 space-y-2 text-left">
        <li>
           “How did I feel during that patient interaction/ consultation?” 
        </li>
        <li>
           “Did I ask open-ended questions or make assumptions?” 
        </li>
        <li>
            “Would I have approached this differently with another patient?” 
        </li>
      ...
      {/* Text Area */}
      <section className=" absolute top-[440px] left-[-6px] mt-6 px-5 flex justify-center">
        <textarea
          value={content}
      ...
      <div className="px-5 mt-4">
        <Button
          onClick={handleSave}
   className="absolute top-[840px] left-1/2 transform -translate-x-1/2 w-[195px] h-[49px] rounded-[25px] bg-transparent font-['Poppins',Helvetica] font-semibold text-[#F89725] text-base tracking-[0.48px] flex items-center justify-center hover:bg-transparent hover:text-[#F89725] focus:outline-none active:bg-transparent"
 >
          Save Reflection
        </Button>
      </div>
       ...
       <section className="flex flex-col items-center px-4 mt-10">
        <Link
          to="/BiasSelfCheck"
          className="absolute top-[955px] left-1/2 transform -translate-x-1/2 w-[195px] h-[49px] bg-[#f89725] rounded-[25px] font-['Poppins',Helvetica] font-semibold text-black text-base tracking-[0.48px] hover:bg-[#e88615] flex items-center justify-center"
        >
          Next
        </Link>
      </section>
