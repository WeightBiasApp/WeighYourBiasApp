...
export const SIResources = (): JSX.Element => {
  ...
  const sectionCards = [
    {
      ...
      link: "https://onlinelibrary.wiley.com/doi/full/10.1111/obr.13494",
      subtitle: "Weight stigma impacts negatively healthcare quality and hinders public health goals. The aim of this review was to identify strategies for minimizing weight bias...",
      description: "Talumaa, B., Brown, A., Batterham, R. L., & Kalea, A. Z.",
    },
  ...
  return (
    <main className="relative h-[1044px] w-full bg-[#e6ebf0] max-w-[390px] mx-auto">
      ...
      <div className="w-full h-[136px] bg-[#2e3b42] rounded-[0px_0px_25px_25px] shadow-[0px_4px_4px_#00000040]">
        <h1 className="absolute w-[363px] top-[49px] left-[70px] font-['Inter',Helvetica] font-bold text-white text-[24px] text-center tracking-[0.50px] max-w-[250px] leading-8">
         Clinical Weight Stigma Resources
        </h1>
      </div>
       {/* Exit Button */}
