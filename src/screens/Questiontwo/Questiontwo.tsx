...
export const Questiontwo = (): JSX.Element => {
...
<Button
  ...
  >
    ...
    <Link to="/question-three">
     <Button className="mt-[30px] w-[205px] h-[49px] bg-[#f89725] rounded-[25px] border font-['Poppins',Helvetica] font-semibold text-black text-base tracking-[0.48px] ">
       Next
     </Button>
   </Link>
